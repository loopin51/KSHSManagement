...
const firebaseConfig = {
  ...
  projectId: process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID || (process.env.NODE_ENV === 'development' ? 'demo-equip-track' : 'YOUR_PROJECT_ID'),
...
if (process.env.NODE_ENV === 'development') {
    try {
        ...
        // The seed function checks if data exists before populating.
        seedDatabase();
    } catch (error) {
